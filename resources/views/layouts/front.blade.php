        ...
        <ul class="main-menu-m">
            ...
            @auth
                ...
                <li class="@if(request()->is('my-orders')) active @endif">
                    <a href="{{route('user.orders')}}" class="stext-102 cl2 hov-cl1 trans-04">Meus Pedidos</a>
                </li>
                <li>
        ...
        <div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
            <ul class="sidebar-link w-full">
                ...
                @auth()
                    ...
                    <li class="p-b-13 @if(request()->is('my-orders')) active @endif" >
                        <a href="{{route('user.orders')}}" class="stext-102 cl2 hov-cl1 trans-04">Meus Pedidos</a>
                    </li>
                    <li class="p-b-13">
                        <a class="stext-102 cl2 hov-cl1 trans-04" href="#" onclick="event.preventDefault();
                                                      document.querySelector('form.logout').submit(); ">Sair</a>
                ...
                @guest
                    ...
                    <li class="p-b-13" >
                        <a class="stext-102 cl2 hov-cl1 trans-04" href="{{route('register')}}" >
                            Registrar
                        </a>
                    </li>
                @endguest
            ...
            <div class="sidebar-gallery w-full p-tb-30">
					<span class="mtext-101 cl5">
                        <a href="https://www.instagram.com/mallybr/" style="text-decoration: none;">
                            @ mallybr
                        </a>
					</span>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    Qualquer duvida você pode entrar em contato com o nosso atendimento via whatsapp, email ou nossas redes sociais.
                </p>
                ...
                <div class="p-t-27">
                    ...
                    <a href="https://www.instagram.com/mallybr/" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
